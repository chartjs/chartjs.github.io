...
function color(value) {
  return isPatternOrGradient(value) ? value : index$1(value);
}
function getHoverColor(value) {
  return isPatternOrGradient(value) ? value : index$1(value).saturate(0.5).darken(0.1).hexString();
}
